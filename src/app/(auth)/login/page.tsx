      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-2xl">
          <h2 className="text-slate-800 font-semibold text-lg mb-5 flex items-center gap-2">
            <LogIn className="w-4 h-4 text-blue-700" /> Entrar
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoFocus
                required
                className="w-full border border-slate-300 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full border border-slate-300 rounded-xl px-3 py-2.5 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <button
                  type="button"
